...
export interface ApplicationStatisticsPanelProps {
 ...
 */
export const ApplicationStatisticsPanel: React.FC<ApplicationStatisticsPanelProps> = ({
...
export default ApplicationStatisticsPanel;
